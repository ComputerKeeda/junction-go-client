module github.com/ComputerKeeda/junction-go-client
...
require (
	github.com/ComputerKeeda/junction v0.0.0-20210909115347
...
replace github.com/ComputerKeeda/junction => ../junction
